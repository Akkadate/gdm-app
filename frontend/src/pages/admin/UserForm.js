  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    try {
      ...
      if (id) {
        ...
        // ถ้าเป็นผู้ป่วยให้อัปเดตหรือสร้างข้อมูลในตาราง patients
        if (isPatient) {
          try {
            ...
            if (error.response && error.response.status === 404) {
              ...
              toast.error('บันทึกข้อมูลผู้ป่วยไม่สำเร็จ');
            }
          }
        }
        ...
        // ถ้าเป็นผู้ป่วยให้สร้างข้อมูลในตาราง patients
        if (isPatient && response.data && response.data.id) {
